    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <motion.h2
            className="text-5xl font-bold mb-6 leading-tight bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-indigo-600"
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
            viewport={{ once: true }}
            transition={{ duration: 0.5, delay: 0.1 }}
          >
            Elevating Aviation Education Since 2005
          </motion.h2>
          ...
          >
            We provide cutting-edge training programs and state-of-the-art facilities
              ...
              {features.map((feature, index) => (
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-8 z-20 text-white">
                    ...
                    <p className="text-white/80 mb-4 max-w-lg">{feature.description}</p>
                  </div>
                </motion.div>
              ))}
            ...
            >
              <div>
                ...
                <motion.button 
                  ...
                  whileHover={{ x: 5 }}
                >
                  Learn more about our approach <FiArrowRight className="ml-2" />
                </motion.button>
              </div>
        ...
        <motion.div
          ref={statsRef}
          className="mb-20 py-16 px-8 lg:px-16 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl shadow-xl text-white relative overflow-hidden"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.6 }}
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              {stats.map((stat, index) => (
                ...
                >
                  <div className="mb-4 w-16 h-16 bg-white/10 backdrop-blur-sm rounded-full mx-auto flex items-center justify-center shadow-lg">
        ...
        <motion.div
          ...
          transition={{ duration: 0.6 }}
        >
          <h3 className="text-3xl font-bold mb-6">Ready to Start Your Aviation Journey?</h3>
          <p className="text-gray-600 mb-8 text-lg">
            Join thousands of successful graduates who have launched their aviation careers with us.
            Our comprehensive programs and expert instructors are ready to guide you every step of the way.
          </p>
